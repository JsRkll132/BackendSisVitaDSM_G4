from ..repository.UsurarioRepository import getUsers,userLoginRepository,userRegisterRepostory,beckQuestionsRepository,userSubmitFormRepository
...
def beckQuestionsService():
    return beckQuestionsRepository()
